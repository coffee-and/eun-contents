export const RELATIONSHIP_TYPES = [
  ...
  { id: "family", title: "가족", description: "익숙해서 놓쳤던 마음을 다시 알아보는 질문", icon: "○", accent: "green" },
  { id: "friends", title: "친구", description: "추억과 취향, 서로의 진짜 모습을 알아보는 질문", icon: "✦", accent: "blue" },
];

export const QUESTION_MOODS = [
  { id: "light", title: "가볍게 알아가기", description: "취향과 일상, 우리를 소개하는 편안한 질문", icon: "01" },
  { id: "honest", title: "조금 더 솔직하게", description: "감정과 가치관, 삶의 기준을 나누는 질문", icon: "02" },
  { id: "memory-future", title: "추억과 미래", description: "함께했던 순간과 앞으로의 바람을 기록하는 질문", icon: "03" },
];
...
const COMMON_QUESTIONS = {
  light: [
    ...
    ["light-09", "나를 소개해요", "지금 나를 가장 잘 설명하는 좌우명이나 문장은 무엇인가요?"],
    ["light-10", "취향과 일상", "최근 사소하지만 기분 좋았던 일은 무엇인가요?"],
    ["light-11", "서로를 알아가요", "상대가 의외로 잘한다고 느끼는 것은 무엇인가요?"],
    ["light-12", "취향과 일상", "함께 보내는 평범한 하루 중 가장 좋아하는 순간은 언제인가요?"],
  ],
  honest: [
    ["honest-01", "가치관과 삶", "삶에서 가장 중요하게 생각하는 것은 무엇인가요?"],
    ["honest-02", "가치관과 삶", "행복한 삶을 위해 꼭 필요하다고 생각하는 것은 무엇인가요?"],
    ...
    ["honest-09", "가치관과 삶", "쉽게 포기할 수 없는 나만의 원칙은 무엇인가요?"],
    ["honest-10", "감정과 소통", "내가 상처받았을 때 보이는 모습은 어떤가요?"],
    ["honest-11", "감정과 소통", "상대가 무심코 지나쳤을 수 있는 나의 노력이 있나요?"],
    ["honest-12", "가치관과 삶", "다른 사람이 나를 어떤 사람으로 기억해주면 좋겠나요?"],
  ],
  "memory-future": [
    ...
    ["future-09", "우리의 추억", "사진으로 꼭 다시 남기고 싶은 순간은 무엇인가요?"],
    ["future-10", "우리의 추억", "함께 어려움을 이겨냈다고 느낀 순간은 언제인가요?"],
    ["future-11", "꿈과 미래", "앞으로 함께 만들고 싶은 작은 습관은 무엇인가요?"],
    ["future-12", "꿈과 미래", "상대의 꿈을 위해 도와주고 싶은 일은 무엇인가요?"],
  ],
};
