...
export const CONTENT_CATALOG = [
  {
    ...
    iconSrc: "/icons/content/relationship-hearts.svg",
    iconAlt: "겹친 두 개의 하트",
    theme: "relationship",
  ...
  },
  {
    ...
    description:
      "연인, 부부, 가족, 친구와 서로를 조금 더 알아가는 질문을 기록해요.",
    iconSrc: "/icons/content/together-chat.svg",
    iconAlt: "겹친 두 개의 말풍선",
    theme: "couple",
    status: CONTENT_STATUS.ACTIVE,
    actionLabel: "문답 시작하기",
  },
  {
    ...
    iconSrc: "/icons/content/saju-yinyang.svg",
    iconAlt: "초록색 음양 상징",
    theme: "saju",
  ...
  },
  {
    ...
    iconSrc: "/icons/content/mini-puzzle.svg",
    iconAlt: "파란색 퍼즐 조각",
    theme: "game",
    status: CONTENT_STATUS.COMING_SOON,
    actionLabel: "준비 중",
