...
const LEGACY_DATABASE_MODE = "marriage";
...
export function toDatabaseRelationshipMode(value) {
  const normalizedMode = normalizeRelationshipMode(value);

  if (normalizedMode === RELATIONSHIP_MODE.MARRIED) {
    return LEGACY_DATABASE_MODE;
  }
